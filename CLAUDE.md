...
**Admin (session cookie):** `GET /api/status`, `GET /api/metrics`, `GET /api/metrics/stream`, `GET /api/dns`, `GET /api/domain-list`, `POST /api/actions` including `domain-autopilot`
